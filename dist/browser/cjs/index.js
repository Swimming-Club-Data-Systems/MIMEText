...
var MIMEMessageHeader = /*#__PURE__*/function () {
  function MIMEMessageHeader(placement) {
    ...
    this.store = [{
      ...
      dump: function dump(vs) {
        return _mapInstanceProperty__default["default"](vs).call(vs, function (v) {
          return v.dump();
        }).join(', ');
      }
    }, {
      ...
      generator: function generator(ctx) {
        ...
        var randomstr = _sliceInstanceProperty__default["default"](_context = Math.random().toString(36)).call(_context, 2);

        var domain = _filterInstanceProperty__default["default"](_context2 = ctx.store).call(_context2, function (item) {
  ...
  _createClass__default["default"](MIMEMessageHeader, [{
    ...
    value: function toObject() {
      ...
      return _reduceInstanceProperty__default["default"](_context3 = this.store).call(_context3, function (memo, item) {
    ...
    value: function dump(envctx) {
      ...
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
          ...
          if (!v) continue;
          lines += _concatInstanceProperty__default["default"](_context4 = "".concat(item.name, ": ")).call(_context4, item.dump(v, ctx), "\r\n");
        }
      } catch (err) {
        _iterator3.e(err);
      } finally {
